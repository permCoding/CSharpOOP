...
По аналогии с проектом **Шахматные фигуры**  
...
Создайте:  
Базовый **класс** для шахматных фигур Figure  
**Классы** наследники: Horse, Rook  
В программе **диалог** с пользователем: ввод позиции белой фигуры - вывод ответа.  

Базовый класс декларирует:  
...
Метод CheckPos на вход получает позицию белой фигуры и проверяет как бьётся это поле чёрной фигурой - на выход возвращает true (если на поле можно ставить белую фигуры) или false (нельзя ставить белую фигуру, поле бьётся чёрной фигурой).  

В классах должны быть ***конструкторы*** с инициализацией свойств Name и Pos.  
Продемонстрируйте понимание возможностей перегрузки конструкторов.  

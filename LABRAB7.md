...
Таким образом, можно наследование в сочетании с полиморфизмом позволяет общие методы содержать в базовом классе, а в наследниках добавлять или изменять функционал.  

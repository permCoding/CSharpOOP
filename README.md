...
[Вопросы для собеседования](https://github.com/permCoding/CSharpOOP/blob/master/questions.md)  
...
**Лекция 19, 20** - **Interfaces**  
**01.12.2020**  

1) Интерфейсы  
* Interface1 - объединяем в список разные классы  
* Interface2 - класс от нескольких интерфейсов с одинаковым методом  
* Interface3 - класс на классах  
* Interface4 - класс на интерфейсах  

2) Нужно завершить рассмотрение проекта с Лекции **CSV**  

3) в дальнейшем сравнить полиморфизм методов и классов
...
**Лекция 21, 22** - **SQLite**  
**__.12.2020**  
Нужно завершить рассмотрение проекта с Лекции **CSV**.  

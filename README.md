...
4) **Расширение GitHub** Extension for Visual Studio (можно через меню VS "Расширения" / "Управление расширениями") или скачать пак [тут](https://marketplace.visualstudio.com/items?itemName=GitHub.GitHubExtensionforVisualStudio).  
